...
import first from "@/assets/experiencias/restaurantetren/restaurantetren1.png";
              ...
              <CarouselContent>
                ...
                <CarouselItem>
                  <div className="relative h-[400px] md:h-[500px] lg:h-[600px] rounded-lg overflow-hidden">
                    <img
                      src={experiencias[0].images[0]}
                      alt={`${experiencias[0].title}`}
          ...
          <div className="grid pl-8 pr-8 gap-8">
            <div className=" space-y-6">
                ...
                <div className="lg:col-span-3">
                  <div>
                    ...
                    <p className="text-[#3A7303] font-openSans leading-relaxed">
                      El Tren del Sazón es una parada gastronómica ideal para
                      quienes recorren la ruta del tren y disfrutan del turismo
                      rural. Ofrece platos típicos preparados con el auténtico
                      sabor de la cocina campesina: carnes a la parrilla,
                      pescados frescos, especialidades como frijolada en leña,
                      sancocho y ajiaco santafereño.
                    </p>
                    <p className="text-[#3A7303] mt-4 font-openSans leading-relaxed">
                      Un lugar acogedor para disfrutar en familia, rodeado de
                      naturaleza y tradición.
                    </p>
                    <p className="text-[#3A7303] mt-4 font-openSans leading-relaxed">
                      Estación gastronómica de la zona rural de Zipacón
                    </p>
                    <p className="text-[#3A7303] mt-4 font-openSans leading-relaxed">
                      Abierto de lunes a miércoles y de viernes a domingo, de
                      7:30 a.m. a 5:30 p.m.
                    </p>
                    <p className="text-[#3A7303] mt-4 font-openSans leading-relaxed">
                      Encuéntranos en Google Maps: Restaurante Bar Tren del
                      Sazón
                    </p>
                  </div>
                </div>
              ...
              <div className="w-full h-[360px] rounded-[15px] overflow-hidden">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3976.3690659361296!2d-74.42811942435927!3d4.705786795269215!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f6f57c19af7fd%3A0x7e0ae58c0930143b!2sRestaurante%20Bar%20Tren%20del%20Sazon!5e0!3m2!1sen!2sco!4v1763860448602!5m2!1sen!2sco"
                  // width="600"
                  // height="450"
...
export default RestauranteTren;
