...
import first from "@/assets/hospedajes/colombiamicasa/micasa1.png";
import second from "@/assets/hospedajes/colombiamicasa/micasa2.png";
import third from "@/assets/hospedajes/colombiamicasa/micasa3.png";
import fourth from "@/assets/hospedajes/colombiamicasa/micasa4.png";
import fifth from "@/assets/hospedajes/colombiamicasa/micasa5.png";
import sixth from "@/assets/hospedajes/colombiamicasa/micasa6.png";
          ...
          <div className="grid pl-8 pr-8 gap-8">
            <div className=" space-y-6">
                ...
                <div className="lg:col-span-3">
                  <div>
                    ...
                    <p className="text-[#3A7303] font-openSans leading-relaxed">
                      Es una casa vacacional ubicada en un entorno natural,
                      ideal para desconectarse de la rutina urbana y disfrutar
                      de un descanso de calidad. El diseño combina una fachada
                      pintoresca en tonos rosa y blanco con interiores modernos
                      y bien equipados. Un jardín amplio, espacios comunes
                      acogedores y habitaciones limpias y funcionales.
                    </p>
                  </div>
                    ...
                    <div>
                      <ul className="pl-6">
                        <li className="list-disc text-[#3A7303]">
                          <div className="flex items-center mb-1 text-[#3A7303] font-openSans ">
                            <span className="font-openSans">
                              Sala de estar con muebles cómodos
                            </span>
                          </div>
                        </li>
                        <li className="list-disc text-[#3A7303]">
                        ...
                        <li className="list-disc text-[#3A7303]">
                          <div className="flex items-center mb-1 text-[#3A7303] font-openSans ">
                            <span className="font-openSans">
                              Habitaciones con camas dobles y sencillas,
                        ...
                        <li className="list-disc text-[#3A7303]">
                          <div className="flex items-center mb-1 text-[#3A7303] font-openSans ">
                            <span className="font-openSans">Baños</span>
                          </div>
                        </li>
                      </ul>
                    </div>
              ...
              <div className="w-full h-[360px] rounded-[15px] overflow-hidden">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63626.96910545694!2d-74.51487055136717!3d4.650055399999996!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8e3f6f7342306549%3A0xcd9894662dfb848e!2sEl%20Refugio%20de%20Yahv%C3%A9%20%2F%20Colombia%20Mi%20Casa!5e0!3m2!1sen!2sco!4v1763770369331!5m2!1sen!2sco"
                  // width="600"
                  // height="450"
