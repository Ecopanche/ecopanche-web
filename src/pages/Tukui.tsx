...
import first from "@/assets/hospedajes/tukui/tukui1.png";
import second from "@/assets/hospedajes/tukui/tukui2.png";
import third from "@/assets/hospedajes/tukui/tukui3.png";
import fourth from "@/assets/hospedajes/tukui/tukui4.png";
import fifth from "@/assets/hospedajes/tukui/tukui5.png";
import sixth from "@/assets/hospedajes/tukui/tukui6.png";
              ...
              <div className="grid lg:grid-cols-5 md:gap-8 sm:gap-4 lg:gap-16 pt-8 pb-12">
                <div className="lg:col-span-3">
                  <div>
                    ...
                    <p className="text-[#3A7303] font-openSans leading-relaxed">
                      Es un destino ecoturístico ubicado en La Mesa,
                      Cundinamarca, enfocado en el avistamiento de colibríes y
                      la experiencia campestre. Ofrece planes de pasadía y
                      hospedaje en un entorno natural con senderos ecológicos,
                      gastronomía típica y espacios para relajarse.
                    </p>
                  </div>
                  ...
                  <div className="mt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                      ...
                      <div>
                        ...
                        <ul className="list-disc list-inside text-[#3A7303] font-openSans space-y-1">
                          <li>Hospedaje para pareja</li>
                          <li>Cama doble</li>
                          <li>Desayuno incluido</li>
                          <li>Avistamiento de colibríes</li>
                          <li>Sendero ecológico</li>
                          <li>Parqueadero</li>
                          <li>Decoración adicional disponible</li>
                        </ul>
                      </div>
                      ...
                      <div>
                        <h3 className="text-[#3A7303] font-openSans font-medium mb-3">
                          Plan AMAZILIA – máximo 3 personas
                        </h3>
                        <ul className="list-disc list-inside text-[#3A7303] font-openSans space-y-1">
                          <li>Hospedaje familiar</li>
                          <li>Cama doble + cama sencilla</li>
                          <li>Desayuno incluido</li>
                          <li>Avistamiento de colibríes</li>
                          <li>Sendero ecológico</li>
                    ...
                    <div className="mt-12">
                      ...
                      <ul className="list-disc list-inside text-[#3A7303] font-openSans space-y-1">
                        <li>Hospedaje para pareja</li>
                        <li>Cama extragrande (extradoble)</li>
                        <li>Desayuno incluido</li>
                        <li>Avistamiento de colibríes</li>
                        <li>Sendero ecológico</li>
                        <li>Postre incluido</li>
                ...
                <div className="lg:col-span-2">
                  <div className="rounded-[15px] relative border p-5 border-[#D8D9D0]">
                    ...
                    <div>
                      <div className="flex items-center mb-1 text-[#3A7303] font-openSans font-medium ">
                        <span className="font-openSans">Condiciones</span>
                      </div>
                      <ul className="pl-6">
                        <li className="list-disc text-[#3A7303]">
                          <div className="flex items-center mb-1 text-[#3A7303] font-openSans ">
                            <span className="font-openSans">
                              Restaurante abierto viernes, sábados, domingos y
                              festivos de 9:00 AM a 4:00 PM
                            </span>
                          </div>
                        </li>
                        <li className="list-disc text-[#3A7303]">
                          <div className="flex items-center mb-1 text-[#3A7303] font-openSans ">
                            <span className="font-openSans">
                              Reserva previa requerida de lunes a jueves
                            </span>
                          </div>
                        </li>
                      </ul>
